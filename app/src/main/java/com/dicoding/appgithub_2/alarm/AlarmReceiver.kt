package com.dicoding.appgithub_2.alarm
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        private const val ID_CHANNEL = "aldi"
    ...
    private fun sendNotif(mContext: Context) {
        val mIntent = mContext.packageManager.getLaunchIntentForPackage("com.dicoding.appgithub_2")
